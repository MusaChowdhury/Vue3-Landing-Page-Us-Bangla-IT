<template>
  ...
  <div class="flex flex-col h-screen">
    <navbar :menu_items=menu_data phone_number="0000test" :company_name=company_name email="test@test" />
...
const company_name = "Chowdhury IT"
...
let home_data = {
  "web": {
    title: "We Make Sure Your Needs Match With Standard Aesthetic.",
    description: "Modern JS framework like Vue3, React, Angular allow us to make application of both multi-page and single-page. Designing stunning and responsive website is our first priority."
  },
